"""Testproblem for ResNet18 with Identity instead of BN on CIFAR-10."""
...
def net_cifar10_resnet18nobn() -> Module:
    """ResNet18 with BatchNormalization layers replaced by Identities."""
...
class cifar10_resnet18nobn(UnregularizedTestproblem):
    """DeepOBS problem for ResNet18 (Identities instead of BN) on CIFAR-10."""

    def set_up(self):
        """Set up the testproblem, i.e. (data, loss_function and network)"""
        self.data = cifar10(self._batch_size)
        self.loss_function = CrossEntropyLoss
        self.net = net_cifar10_resnet18nobn()
